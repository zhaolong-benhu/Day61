...
<head>
    ...
    <!-- <link rel="bookmark"  type="image/x-icon"  href="http://static.v.veimg.cn/image/index/favicon.ico"/>
    <link href="http://static.v.veimg.cn/image/index/favicon.ico" rel="shortcut icon" /> -->
  ...
  <link rel="Stylesheet" type="text/css" href="css/SignSuccessDialog.css"/>

	<style>
	.input-upload{z-index:999;width:100%;height:100%;position:absolute;margin-left:-35px;opacity:0;background-color:#000;display:block;}
	...
	var vdata = {
		...
		'uploadPath':'<?php echo $this->clips['publicData']['uploadPath'];?>',//./upload
		'domain':'<?php echo Yii::app()->request->getHostInfo();?>'//http://wams.veryeast.cn
	}
	</script>
</head>
<body>
	<div class="mw pb90 fl">
		...
		<div class="dis_n tit_box_1 t_50 pf z2000 tc w_100">
			<span class="dis_lb font32 line_h90 pl60 pr60 bgcol_08 b_rad5 col_01">插红旗成功！</span>
		</div>
	    ...
	    <div class="dis_n tit_box_4 t_45 pf z2000 tc w_100">
	    	<span class="dis_lb font24 line_h45 pl60 pr60 pt15 pb15 bgcol_08 b_rad5 col_01">请先关注公众号“酒店人”<br>回复投票进入插红旗</span>
	    </div>
     	...
     	<ul class="bottom_box w_100 pl32 pr32 pf box_s">
	    	<li>
          <a class="font30 line_h42 col_01" onclick="SignSuccess(this)">首页</a></li>
	        ...
	        <li><a href="index.php?a=rank" class="font30 line_h42 col_01">排行榜</a>
      </li>
		</ul>
	</div>
  ...
  <div id="LoginBox">
    ...
    <div class="top" style="margin-top:0px;width:516px;height:220px;">

    </div>
    <a class="com_font get" href="http://special.9first.com/yuehuiv3/Index.shtml" >立即领取</a>
    <a class="com_font cancel" onclick="Close(this)">取消</a>
...
<script>
  ...
  function GetTicket(obj)
  {
    ...
    // this.open('http://www.veryeast.cn/');
