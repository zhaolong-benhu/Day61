...
<head>
	...
	.alert-bgbox{
		...
		background-image:url(./images/share.png);background-repeat:no-repeat;background-position:70% 50px;
	}
	</style>
	<script>
	var vdata = {
...
wx.config({
    debug: false,
    appId: "<?php echo $this->clips['signPackage']['appId'];?>",
    timestamp: <?php echo $this->clips['signPackage']['timestamp'];?>,
    nonceStr: "<?php echo $this->clips['signPackage']['nonceStr'];?>",
    signature: "<?php echo $this->clips['signPackage']['signature'];?>",
    jsApiList: ['onMenuShareTimeline', 'onMenuShareAppMessage']
});
wx.ready(function(){
    wx.onMenuShareTimeline({
        title: '<?php echo $this->clips['signPackage']['title'];?>',
        desc: '<?php echo $this->clips['signPackage']['desc'];?>',
        link: "<?php echo $this->clips['signPackage']['url'];?>",
        imgUrl: '<?php echo $this->clips['signPackage']['imgUrl'];?>',
        type: 'link',
        dataUrl: '',
        success: function () {
        },
