var tmpImgUpload = '/activity/day61/';
/**
 * 点击报名之前检验是否已经关注
 */
...
/**
 * 弹出信息提示框
 * @param show_tb_num1-插红旗成功2-请勿重复报名3-选手搜不到4-请先关注
 */
...
function giveAVote(number,obj){
  // $(this).find("i").css("color","#9a0668");
	$(obj).next().attr("src","images/img_06.png");
...
function upload(ele){
	...
	window.setTimeout(function(){
		...
		$(ele).siblings('div').find("img").attr('src',tmpImgUpload+src+'?r='+Math.random());
